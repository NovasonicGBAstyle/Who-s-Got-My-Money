...
/// <summary>
/// This script will handle things for the rich kid button.
/// </summary>
public class RichKidButton : MonoBehaviour
{
    ...
    /// </summary>
    public void RickKidButtonClicked()
    {
        gameManager.RichKidSelected();
    }
}
